...
void
conf_autostart(struct conf *conf, char *cmd, int no)
{
...
static const struct {
	...
	{ "snaptileright", kbfunc_client_snap, CWM_WIN,
	    {.i = (CWM_RIGHT|CWM_RESIZE)} },
	{ "focusup", kbfunc_client_focus, CWM_WIN, {.i = CWM_UP} },
	{ "focusdown", kbfunc_client_focus, CWM_WIN, {.i = CWM_DOWN} },
	{ "focusleft", kbfunc_client_focus, CWM_WIN, {.i = CWM_LEFT} },
	{ "focusright", kbfunc_client_focus, CWM_WIN, {.i = CWM_RIGHT} },
